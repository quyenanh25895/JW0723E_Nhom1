...
public class XuatExcelControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( FileOutputStream file = new FileOutputStream("D:\\ITPLUS\\" + "\\Excel\\" + "hoa-don-" + ngayXuat + "-" + Integer.toString(randomNum) + ".xlsx")) {
            ...
            for (Invoice o : list) {
                ...
                for (Account a : listAllAccount) {
                    if (o.getAccountID() == a.getId()) {
                        ...
                        cell3 = row.createCell(3);
                        cell3.setCellValue(request.getParameter("dateHoaDon1"));
                    }
                }
            }
            workbook.write(file);
