...
@WebServlet("/xuatExcelTop10ProductControl")
...
public class XuatExcelTop10ProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FileOutputStream file=new FileOutputStream("D:\\ITPLUS\\"+"\\Excel\\"+"top10-sp-ban-chay-nhat"+Integer.toString(randomNum)+".xlsx");
