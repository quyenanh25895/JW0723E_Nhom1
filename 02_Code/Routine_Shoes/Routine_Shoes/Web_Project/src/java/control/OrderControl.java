		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setSubject("Dat hang thanh cong tu Routine Shoes");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear ").append(name).append("<br>");
				sb.append("Ban vua dat dang tu Routine Shoes. <br> ");
				...
				sb.append("Cam on ban da dat hang tai Routine Shoes<br>");
				sb.append("Ki ten");
                                sb.append("Routine Shoes");
