       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        DAO dao = new DAO();
            ...
            if (!password.equals(a.getPass())) {
                ...
                request.setAttribute("error", "Mat khau nhap lai sai");
                request.getRequestDispatcher("ChangePassWord.jsp").forward(request, response);

            } else if (newPassword.equals(a.getPass())) {
                request.setAttribute("error", "Mat khau moi trung voi mat khau cu");
                request.getRequestDispatcher("ChangePassWord.jsp").forward(request, response);
                
            } else {
                String passMH = MaHoa.toSHA1(newPassword);
                dao.changePassWord(id, passMH);
