  ...
  <div class="position-sticky">
    <div class="list-group list-group-flush mx-3 mt-4">
      ...
      <a
        ...
        class="list-group-item list-group-item-action py-2 ripple"
      >
        <i class="fas fa-user-circle fa-fw me-3"></i
      ...
      <a
        href="managerSupplier"
        class="list-group-item list-group-item-action py-2 ripple"
      >
        <i class="fas fa-parachute-box fa-fw me-3"></i
        ><span>Quản lý nhà cung cấp</span>
      </a>

      <a href="home" class="list-group-item list-group-item-action py-2 ripple">
        <i class="fas fa-fw me-3"></i><span>Trang Chủ</span>
      </a>
    </div>
  </div>
</nav>
