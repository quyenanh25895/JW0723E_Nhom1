            ...
            <div class="container">
                <div class="row nav-menu">
                    ...
                    <div class="col-sm-3 col-left">          
                        ...
                        <div class="card-header title-last text-white text-uppercase">Last product</div>
                        <div class="card-body card-body-last">
                            <img class="img-fluid" src="${p.image}" />
                            <h5 class="card-title show_txt show_txt_last"  ><a href="detail?pid=${p.id}" title="View Product">${p.name} </a></h5>
                        <p class="card-text card-text-last" style="justify-content: center; display: flex;"> ${p.title} </p>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row" style="margin-top:25px">            
                        ...
                        <div class="col-sm-12">
                            ...
                            <button onclick="loadMoreNike()" class="btn btn-primary btn-more" style="margin-top: 15px;">Load more</button>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top:25px">            
                        ...
                        <div class="col-sm-12">
                            ...
                            <button onclick="loadMoreAdidas()" class="btn btn-primary btn-more"  style="margin-top: 15px;">Load more</button>
                        </div>
                    </div>
                </div>
            </div>

            <div class="row nav-menu" style="margin-top:50px">            
                <div class="col-sm-12">
                    <div id="content" class="row">
                        <div class=" col-12 col-md-12 col-lg-6">
                            <div class="card-body">
                                <h4 class="card-title show_txt" style="text-align:center; font-size:18pt; color:#b57b00;">Về chúng tôi</h4>
                                <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">Routine Shoes</h2>
                                <p style="text-align:center;">Uy tín lâu năm chuyên cung cấp giày thể thao sneaker nam, nữ hàng Replica 1:1 - 
                                    Like Auth với chất lượng đảm bảo và giá tốt nhất tại Hà Nội, Thành phố Hồ Chí Minh.</p>
                                <p>Bạn đang cần tìm một đôi giày thể thao sneaker đẹp và hợp thời trang và đang hot Trends 
                                    ...
                                    Hãy đến với Routine Shoes – nơi bạn thỏa lòng mong ước mà chỉ phải chi ra 1 phần nhỏ so với dòng chính hãng ngoài store 
                                    mà vẫn sắm cho mình được một đôi chất lượng từ rep 1:1 đến siêu cấp like auth.</p>                  
                            </div>  
                        </div>
                        <div class=" col-12 col-md-12 col-lg-6">
                            <img class="card-img-top" src="./images/AboutShop.png" alt="Card image cap">        
                        </div>
                    </div>
                </div>
            </div>
